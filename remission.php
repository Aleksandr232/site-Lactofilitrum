...
<head>
    ...
    <title>Библиотека Ремиссии - Нетоксичный контент</title>
            ...
            <section id="remission-section" class="content-section active">
                ...
                <div class="table-container">
                    <table id="remission-table" class="data-table">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7">Загрузка элементов...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            fetch('php/api/remission.php')
                ...
                .then(data => {
                    ...
                    if (data.success && data.items && data.items.length > 0) {
                        ...
                        tableBody.innerHTML = '<tr><td colspan="7">Нет элементов</td></tr>';
                    }
                })
                .catch(error => {
                    console.error('Ошибка загрузки элементов remission:', error);
                    tableBody.innerHTML = '<tr><td colspan="7" style="color: red;">Ошибка загрузки</td></tr>';
                });
        }
